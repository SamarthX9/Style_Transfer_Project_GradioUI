...
def parse_arguments():
    ...
    parser.add_argument('--content_dir', type=str, default='C:/Users/samar/Documents/NST_Project/content_data',
                        help='Location of content dataset')
    parser.add_argument('--style_dir', type=str, default='C:/Users/samar/Documents/NST_Project/style_data',
                        help='Location of style dataset')
    parser.add_argument('--vgg', type=str, default='C:/Users/samar/Documents/NST_Project/vgg_normalised.pth',
